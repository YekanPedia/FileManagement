...
namespace YekanPedia.FileManagement.Proxy.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ApiController : YekanPedia.FileManagement.Proxy.Controllers.ApiController
    {
        public T4MVC_ApiController() : base(Dummy.Instance) { }

        [NonAction]
        partial void RemoveOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, int day);

        [NonAction]
        public override System.Web.Mvc.JsonResult Remove(int day)
        {
